...
const Vue7 = (props) => {
 ...
 // const [datUser1, setDatUser1] =React.useState("")
  ref = firebase.firestore().collection("2023OUTILS")
  refAce = firebase.firestore().collection("/2023OUTILS/a5pub/Accessoire")
 ...
 let refStatut = firebase.firestore().collection("/2023OUTILS/a1Dessin/statut")
...
<View style={{flexDirection:'row',justifyContent:'space-between',padding:10}}>
  <Image style={{height:100,width:'49%'}} source={require('../../assets/microcontrolleur.gif')} />
  <Image style={{height:100,width:'49%'}} source={require('../../assets/plancheDessin.jpg')} />
</View>
    ...
    <View style={{width:WIDTH,backgroundColor:'#000',height:55,padding:10,marginTop:15}}>
      ...
      
      {
        ...
        list.type=='art' ?
         ...
         : <ImageBackground source={require('../../assets/mecanique.gif')} key={key} style={{height:155,width:WIDTH,backgroundColor:'red',marginTop:25}}></ImageBackground>
        )
      }
      {/* <VueBande /> */}
{/*
      ...
      <ScrollView>
        ...
        <View style={{backgroundColor:'#484848',borderBottomLeftRadius:30,borderBottomRightRadius:30}}>
          ...
          <View style={{width:WIDTH*0.45,padding:15}}>
            <Text style={{color:'white',fontSize:15, alignSelf:'center',fontWeight:'800'}}>Prix : {ChooseChoise[3]} fcfa</Text>
  ...
  const Accessoires=({taille,name,size,image,price,batterie,couleur,origine,stock,ecran,similaire})=>{
    ...
    return(
      ...
      <View style={{flexDirection:'column'}}>
        <Image source={{uri:image}} style={{height:100,width:150,borderRadius:50,backgroundColor:'red',margin:5}} />
