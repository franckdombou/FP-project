...
import img1 from '../../assets/fastfood/ose.jpg'
import img2 from '../../assets/fastfood/fritplantain.jpg'
import img3 from '../../assets/fastfood/pilipili.jpg'
import img4 from '../../assets/fastfood/plat1.jpg'
import { UserContextNewNav } from '../../navigation/NewNav'
import CarreFood from '../../Components/pinterest/CarreFood'
...
const Vue5 = (props) => {
 ...
 // const [datUser1, setDatUser1] =React.useState("")
  ref = firebase.firestore().collection("2023FOOD")
  refAce = firebase.firestore().collection("/2023FOOD/a2PainOme/Accessoires")
 ...
 let refStatut = firebase.firestore().collection("/2023FOOD/000001/statut")
...
<View style={{height:1,width:WIDTH,backgroundColor:'#bbbb',marginTop:10}}></View>

{/*<ImageBackground style={{height:150}} source={require('../../assets/iphonegif2.gif')}></ImageBackground>*/}
<View style={{flexDirection:'row',justifyContent:'space-between',padding:10,}}>
  <Image style={{height:100,width:'49%'}} source={require('../../assets/fast2.gif')} />
  <Image style={{height:100,width:'49%'}} source={require('../../assets/food1.gif')} />
</View>
      ...
      <ScrollView horizontal style={{margin:17,}}>
      
        {
          dataAcc.map((list,index)=>
            <Accessoires similaire={list.Similaire} name={list.ingredient} price={list.prix} image={list.image}   key={index} />
          )
        }
      </ScrollView>
      ...
      {/*<View style={{width:"45%",height:100,borderRadius:20,backgroundColor:'red',marginTop:20}}>
        <Video source={{uri}} 
      ...
      
      {
        data.map((list,key)=>
        list.type=='art' ?
          <CarreFood similaire={list.Similaire}   price={list.prix} name={list.ingredient} image={list.image}  key={key} />
         :
        ( list.type=='vid' ? 
        <View style={{width:"45%",height:250,borderRadius:20,backgroundColor:'red',marginTop:20}}>
        <Video source={{uri}} 
          style={{width:"100%",height:250,borderRadius:20}} 
          useNativeControls 
          resizeMode='cover'
        ...
        />      
         ...
         <ImageBackground source={require('../../assets/food2.gif')} key={key} style={{height:155,width:WIDTH,backgroundColor:'red',marginTop:25}}></ImageBackground>
        )
         )
      }
      {/* <VueBande /> */}
...
//  const refDoc = firebase.firestore().collection('2023NIKE')
  ...
  //fin ajout panier
   ...
   function annuler({image,nom,prix,}){
    ...
    washingtonRef.update({
      userPanier: arrayRemove({"etat":"panier", "image": image ,"nom": nom, "prix":prix,"qty":1})
    });
...
const ModPanier = ()=>{
  ...
  const Accessoires=({name,image,price,similaire})=>{
